...
public class CardConfig {
	...
	private static final String DWALLET_EMAIL = "DwalletEmail"; //$NON-NLS-1$
	private static final String DWALLET_PASSWORD = "DWalletPassword"; //$NON-NLS-1$
	private static final String DWALLET_PAYMENTTYPE = "DWalletPaymentType";
	private static final String DWALLET_POINTCONVERSION = "DWalletPointConversion";
	
	public static void setDWalletEmail(String email) {
		AppConfig.put(DWALLET_EMAIL, email); //$NON-NLS-1$
	}
	
	public static String getDWalletEmail() {
		return AppConfig.getString(DWALLET_EMAIL, null); //$NON-NLS-1$
	}
	
	public static void setDWalletPassword(String password) {
		AppConfig.put(DWALLET_PASSWORD, password); //$NON-NLS-1$
	}
	
	public static String getDWalletPassword() {
		return AppConfig.getString(DWALLET_PASSWORD, null); //$NON-NLS-1$
	}
	
	public static void setDWalletPaymentType(String paymentType) {
		AppConfig.put(DWALLET_PAYMENTTYPE, paymentType); //$NON-NLS-1$
	}
	
	public static String getDWalletPaymentType() {
		return AppConfig.getString(DWALLET_PAYMENTTYPE, null); //$NON-NLS-1$
	}
	
	public static void setDWalletPointConversion(String pointConversion) {
		AppConfig.put(DWALLET_POINTCONVERSION, pointConversion); //$NON-NLS-1$
	}
	
	public static String getDWalletPointConversion() {
		return AppConfig.getString(DWALLET_POINTCONVERSION, null); //$NON-NLS-1$
	}

...
public class PaymentView extends JPanel {
	...
	private com.floreantpos.swing.PosButton btnDWallet;
	...
	private void initComponents() {
		...
		btnDWallet = new PosButton("DWallet");
		actionButtonPanel.add(btnDWallet, "grow, w " + width + "!");
		btnDWallet.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				try {
					ticketProcessor.doSettle(PaymentType.DWALLET, getTenderedAmount());
				} catch (StaleStateException x) {
					POSMessageDialog.showMessageDialogWithReloadButton(POSUtil.getFocusedWindow(), refreshableView);
				} catch (Exception exception) {
					POSMessageDialog.showError(POSUtil.getFocusedWindow(), exception.getMessage());
